package com.einkaufsheld.help2buy.StoreOwnerApp.Account;
...
public class OwnAccountFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.own_fragment_account, container, false);
        Button signOutButton = root.findViewById(R.id.own_account_sign_out_button);
